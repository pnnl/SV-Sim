...
svfile.write('#include "../src/util_nvgpu.cuh"\n')
svfile.write('#include "../src/svsim_nvgpu_mpi.cuh"\n')
...
svfile.write('\tSimulation sim(n_qubits,0);\n')
svfile.write('\tprepare_circuit(sim);\n')
svfile.write('\tsim.upload();\n')
svfile.write('\tsim.sim();\n')
#svfile.write('\tauto* res = sim.measure(1);\n')
#svfile.write('\tprint_measurement(res, n_qubits, 1);\n')
#svfile.write('\tdelete res; \n')
