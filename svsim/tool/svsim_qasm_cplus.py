...
svfile.write('#include "util_cpu.h"\n')
svfile.write('#include "svsim_cpu_omp.hpp"\n')
...
svfile.write('\tint n_cpus=256;\n')
svfile.write('\tSimulation sim(n_qubits, n_cpus);\n')
svfile.write('\tprepare_circuit(sim);\n')
svfile.write('\tsim.upload();\n')
svfile.write('\tsim.sim();\n')
svfile.write('\tauto* res = sim.measure(5);\n')
svfile.write('\tprint_measurement(res, n_qubits, 5);\n')
