...
# Using SVSim NVGPU backend
import libsvsim_py_nvgpu_mpi as svsim_mpi

# Using SV-Sim CPU backend
#import libsvsim_py_cpu_mpi as svsim_mpi

# Using SV-Sim AMDGPU backend
#import libsvsim_py_amdgpu_mpi as svsim_mpi
...
sim = svsim_mpi.Simulation(n_qubits)
