...
#import libsvsim_py_nvgpu_sin as svsim_omp

# Using SV-Sim CPU backend
import libsvsim_py_cpu_sin as svsim_omp

# Using SV-Sim AMDGPU backend
#import libsvsim_py_amdgpu_sin as svsim_omp
...
sim = svsim_omp.Simulation(n_qubits)
