...
// BSD Lincese.
// ---------------------------------------------------------------------------
// File: unit_test_cpu_omp.cpp
// Unit test for OpenMP based CPU state-vector simulation.
// ---------------------------------------------------------------------------
        ...
        ValType* sv_imag_expected)
{
    ...
    {
        if ( fabs(sv_real_expected[i] - sim.sv_real[i]) > ERROR_BAR
                || fabs(sv_imag_expected[i] - sim.sv_imag[i]) > ERROR_BAR)
