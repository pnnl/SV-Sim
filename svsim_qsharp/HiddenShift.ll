...
@Microsoft__Quantum__Samples__ApplyInnerProductBentFunction = constant [4 x void (%Tuple*, %Tuple*, %Tuple*)*] [void (%Tuple*, %Tuple*, %Tuple*)* @Microsoft__Quantum__Samples__ApplyInnerProductBentFunction__body__wrapper, void (%Tuple*, %Tuple*, %Tuple*)* null, void (%Tuple*, %Tuple*, %Tuple*)* null, void (%Tuple*, %Tuple*, %Tuple*)* null]
...
@Microsoft__Quantum__Samples__ApplyShiftedInnerProductBentFunction = constant [4 x void (%Tuple*, %Tuple*, %Tuple*)*] [void (%Tuple*, %Tuple*, %Tuple*)* @Microsoft__Quantum__Samples__ApplyShiftedInnerProductBentFunction__body__wrapper, void (%Tuple*, %Tuple*, %Tuple*)* null, void (%Tuple*, %Tuple*, %Tuple*)* null, void (%Tuple*, %Tuple*, %Tuple*)* null]
...
define void @Microsoft__Quantum__Samples__ApplyInnerProductBentFunction__body(i64 %u, %Array* %qs) {
entry:
...
header__1:                                        ; preds = %exiting__1, %continue__1
  %idx = phi i64 [ 0, %continue__1 ], [ %24, %exiting__1 ]
...
body__1:                                          ; preds = %header__1
  ...
  %17 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %__controlQubits__, i64 0)
  %18 = bitcast i8* %17 to %Qubit**
  %19 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %xs, i64 %idx)
  %20 = bitcast i8* %19 to %Qubit**
  %21 = load %Qubit*, %Qubit** %20, align 8
  store %Qubit* %21, %Qubit** %18, align 8
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
  %22 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %ys, i64 %idx)
...
define void @Microsoft__Quantum__Samples__ApplyShiftedInnerProductBentFunction__body(%Array* %shift, i64 %u, %Array* %qs) {
entry:
...
continue__1:                                      ; preds = %condContinue__1
  %7 = call %Array* @Microsoft__Quantum__Arrays___c31d085e243e41deae9ddadcbe2e0725_Zipped__body(%Array* %shift, %Array* %qs)
...
then0__2:                                         ; preds = %body__1
  call void @__quantum__qis__x__body(%Qubit* %__qsVar1__target__)
...
exit__1:                                          ; preds = %header__1
  ...
  %22 = call %Array* @Microsoft__Quantum__Arrays___c31d085e243e41deae9ddadcbe2e0725_Zipped__body(%Array* %shift, %Array* %qs)
  %23 = call %Array* @Microsoft__Quantum__Arrays___c31d085e243e41deae9ddadcbe2e0725_Zipped__body(%Array* %shift, %Array* %qs)
...
then0__3:                                         ; preds = %body__2
  call void @__quantum__qis__x__body(%Qubit* %__qsVar1____qsVar1__target____)
...
define %Array* @Microsoft__Quantum__Arrays___c31d085e243e41deae9ddadcbe2e0725_Zipped__body(%Array* %left, %Array* %right) {
entry:
...
define %Callable* @Microsoft__Quantum__Samples__InnerProductBentFunction__body(i64 %u) {
entry:
  ...
  %4 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Samples__ApplyInnerProductBentFunction, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
...
define %Array* @Microsoft__Quantum__Samples__HiddenShiftBentCorrelation__body(%Callable* %Ufstar, %Callable* %Ug, i64 %n) {
entry:
  ...
  call void @Microsoft__Quantum__Canon___b61fc53a841046f6a19f4356a37968c8_ApplyToEach__body(%Callable* %0, %Array* %qubits)
  ...
  call void @Microsoft__Quantum__Canon___82855c2b326d418d901a29589c6f2cc5_ApplyToEachA__body(%Callable* %4, %Array* %qubits)
  ...
  call void @Microsoft__Quantum__Canon___82855c2b326d418d901a29589c6f2cc5_ApplyToEachA__adj(%Callable* %8, %Array* %qubits)
  ...
  %10 = call %Array* @Microsoft__Quantum__Arrays___efd2f0520c8c40d58808873151ac9657_ForEach__body(%Callable* %9, %Array* %qubits)
  call void @__quantum__rt__array_update_alias_count(%Array* %qubits, i32 -1)
  call void @__quantum__rt__capture_update_alias_count(%Callable* %Ufstar, i32 -1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %Ufstar, i32 -1)
  call void @__quantum__rt__capture_update_alias_count(%Callable* %Ug, i32 -1)
...
define void @Microsoft__Quantum__Canon___b61fc53a841046f6a19f4356a37968c8_ApplyToEach__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  %0 = call %Range @Microsoft__Quantum__Arrays___274570b9e87e4bc5ad0665f0d2398e5b_IndexRange__body(%Array* %register)
...
define void @Microsoft__Quantum__Canon___82855c2b326d418d901a29589c6f2cc5_ApplyToEachA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define void @Microsoft__Quantum__Canon___82855c2b326d418d901a29589c6f2cc5_ApplyToEachA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define %Array* @Microsoft__Quantum__Arrays___efd2f0520c8c40d58808873151ac9657_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
exit__2:                                          ; preds = %header__2
  ...
  %16 = call %Range @Microsoft__Quantum__Arrays___274570b9e87e4bc5ad0665f0d2398e5b_IndexRange__body(%Array* %array)
...
define void @Microsoft__Quantum__Samples__ApplyInnerProductBentFunction__body__wrapper(%Tuple* %capture-tuple, %Tuple* %arg-tuple, %Tuple* %result-tuple) {
entry:
...
define %Array* @Microsoft__Quantum__Samples__RunHiddenShift__body(i64 %patternInt, i64 %registerSize) {
entry:
...
define %Callable* @Microsoft__Quantum__Samples__ShiftedInnerProductBentFunction__body(%Array* %shift, i64 %u) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %shift, i32 1)
  ...
  %5 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Samples__ApplyShiftedInnerProductBentFunction, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
...
define void @Microsoft__Quantum__Samples__ApplyShiftedInnerProductBentFunction__body__wrapper(%Tuple* %capture-tuple, %Tuple* %arg-tuple, %Tuple* %result-tuple) {
entry:
...
define %Range @Microsoft__Quantum__Arrays___274570b9e87e4bc5ad0665f0d2398e5b_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
  %0 = call i64 @__quantum__rt__array_get_size_1d(%Array* %array)
  %1 = sub i64 %0, 1
