...
define %Array* @Microsoft__Quantum__Samples__SampleRandomNumber__body(i64 %nQubits) {
entry:
  ...
  call void @Microsoft__Quantum__Canon___01cece10447f40d2bd61c66f58fb3884_ApplyToEachA__body(%Callable* %0, %Array* %register)
  %1 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Measurement__MResetZ, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  %2 = call %Array* @Microsoft__Quantum__Arrays___2ae57f882ee047a08faac47f055553f0_ForEach__body(%Callable* %1, %Array* %register)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 -1)
...
define void @Microsoft__Quantum__Canon___01cece10447f40d2bd61c66f58fb3884_ApplyToEachA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
  %0 = call %Range @Microsoft__Quantum__Arrays___8a38a8af23ae4a27b0de29316fddd869_IndexRange__body(%Array* %register)
...
define %Array* @Microsoft__Quantum__Arrays___2ae57f882ee047a08faac47f055553f0_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
exit__2:                                          ; preds = %header__2
  ...
  %16 = call %Range @Microsoft__Quantum__Arrays___8a38a8af23ae4a27b0de29316fddd869_IndexRange__body(%Array* %array)
...
define %Range @Microsoft__Quantum__Arrays___8a38a8af23ae4a27b0de29316fddd869_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
  %0 = call i64 @__quantum__rt__array_get_size_1d(%Array* %array)
  %1 = sub i64 %0, 1
...
define void @Microsoft__Quantum__Canon___01cece10447f40d2bd61c66f58fb3884_ApplyToEachA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define { i64, i8* }* @Microsoft__Quantum__Samples__SampleRandomNumber__Interop(i64 %nQubits) #0 {
entry:
  %0 = call %Array* @Microsoft__Quantum__Samples__SampleRandomNumber__body(i64 %nQubits)
...
define void @Microsoft__Quantum__Samples__SampleRandomNumber(i64 %nQubits) #1 {
entry:
  %0 = call %Array* @Microsoft__Quantum__Samples__SampleRandomNumber__body(i64 %nQubits)
...
exit__1:                                          ; preds = %header__1
  %17 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @2, i32 0, i32 0))
